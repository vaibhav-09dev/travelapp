    ...
    <div className="">
      ...
      <div className="w-full flex flex-col md:flex-row justify-around items-center bg-white py-8 px-4 md:px-12">
        <div className="w-full md:w-1/2">
          ...
          <h1 className="text-4xl md:text-6xl font-bold font-serif text-stone-600">
            Contact Us
          </h1>
          <p className="text-base md:text-xl italic font-serif text-stone-800 text-left mt-4 font-bold">
        ...
        <div className="w-full md:w-1/2 mt-8 md:mt-0">
          <video
            src="https://cdn.pixabay.com/video/2015/10/19/1110-142930245_tiny.mp4"
            autoPlay
            loop
            muted
      ...
      <div className="py-8 px-4 md:px-12">
        <h1 className="text-4xl md:text-5xl font-bold font-serif text-stone-600 text-center underline mb-8">
          Let's get in touch
        </h1>
        <div className="flex flex-col md:flex-row justify-around items-start">
          {/* Address Section */}
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            <h1 className="text-2xl md:text-5xl font-bold font-serif text-stone-600 mb-4">Address:</h1>
            <h2>
              <a
            ...
            <h1 className="text-2xl md:text-5xl font-bold font-serif text-stone-600 mt-8">Call Us:</h1>
            <h2>
              <a
            ...
            <h1 className="text-2xl md:text-5xl font-bold font-serif text-stone-600 mt-8">Email Us:</h1>
            <h2>
              <a
